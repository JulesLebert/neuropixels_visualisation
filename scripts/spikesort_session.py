...
def main():
    ...
    session_name = '17072024_AM_Challah_g0'  # chooses the session folder. Use this to select specific sessions. You can write something to do this batch later if you want, but seems likely that you'll instead be changing this as you go.
